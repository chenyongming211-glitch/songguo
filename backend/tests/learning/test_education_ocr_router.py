...
def test_router_defaults_auto_to_paper_structed() -> None:
    ...
    assert plan.primary_action == EducationOcrAction.PAPER_STRUCTED
    assert plan.expected_output == "structured_questions"
